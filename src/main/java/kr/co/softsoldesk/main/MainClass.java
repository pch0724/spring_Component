...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		TestBean5 xml50 = ctx1.getBean(TestBean5.class);
		System.out.println("xml50 : " + xml50);
		...
		System.out.println("---------------------------------------");
		System.out.println("TestBean5");
		TestBean5 java50 = ctx2.getBean(TestBean5.class);
		System.out.println("java50 : " + java50);
